...
from app.api.v1 import auth, users, content, place, location  # , admin, places, calendar # Placeholder for future routers
...
app.include_router(place.router, prefix="/api/v1/places", tags=["Places"])
